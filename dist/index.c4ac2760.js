...
})({"7umv1":[function(require,module,exports) {
...
function getWeather() {
    const location = (0, _jqueryDefault.default)("#location").val();
    if (!location) return;
    // Use OpenWeatherMap API to get weather data
    (0, _jqueryDefault.default).getJSON(`https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=dcf04c7c38b6e9695746129d8c948d9b`, function(data) {
